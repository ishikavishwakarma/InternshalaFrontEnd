...
import { asyncCreateInternship, asynccurrentResume } from '../store/Actions/resumeActions';

const InternshipResume = ({onClose}) => {
  ...
  return (
    <div className="div rounded pt-2 pl-2 h-fit top-[39vw] w-[35vw] bg-zinc-800 absolute">
      ...
      <h1 className='text-2xl text-white'>Internship Details</h1>
